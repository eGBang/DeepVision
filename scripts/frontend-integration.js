 ...
 * This file demonstrates how to integrate Deepvision with a web frontend
 */

// For React/Vue/Angular applications
export class DeepvisionClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new DeepvisionClient(provider, contractAddress);
